          ...
          <Card className="p-8 mb-12 bg-gradient-to-r from-primary-50 to-white border-l-4 border-l-primary-500">
            <CardContent className="p-0">
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                <p className="mb-4">
                  My journey into software development began during my Computer
                  Engineering studies at Government Engineering College, Modasa,
                  where I graduated with an 8.40 CGPA. What started as curiosity
                  about how systems work evolved into a passion for building
                ...
                <p className="mb-4">
                  ...
                  Technologies, I'm proud to lead the GST product vertical,
                  where we process real-time orders and manage critical
                  integrations that businesses depend on. Being recognized as
                  Employee of the Month three times and receiving the BIAS Award
                  has been incredibly motivating, but what drives me most is the
                  impact our solutions have on real businesses.
                </p>
                <p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Recognized for upholding core values (Belief, Integrity,
                        Accountability, Sincerity) while leading critical
                        backend services
                      </p>
                    </div>
                  </div>
          ...
          <Card className="p-8 text-center bg-gradient-to-r from-primary-600 to-accent text-white">
            <CardContent className="p-0">
              ...
              <p className="text-lg opacity-90 mb-6 max-w-2xl mx-auto">
                I'm always excited to discuss new opportunities, share
                knowledge, or collaborate on interesting projects. Feel free to
                reach out!
              </p>
