          ...
          <Card className="p-8 mb-12 border-l-4 border-l-primary-500 bg-gradient-to-r from-primary-50 via-white to-accent/5">
            <CardContent className="p-0">
              ...
              <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                ...
                real-time order processing systems, downstream integrations, and
                vendor communication pipelines. Responsible for architecting
                scalable solutions that serve millions of requests daily.
              </p>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-sm">99.9% system reliability</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Award className="w-4 h-4 text-purple-500 mt-1 flex-shrink-0" />
                      <span className="text-sm">3x Employee of the Month</span>
                    </li>
                  </ul>
                </div>
                <div>
